      ...
      <div class="container">
        ...
        <div class="row gy-4">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <img src="{{asset('home/assets/img/about.jpg')}}" class="img-fluid rounded-4 mb-4" alt="">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
            <div class="content ps-0 ps-lg-5">
              ...
              <div class="position-relative mt-4">
                <img src="{{asset('home/assets/img/about-2.jpg')}}" class="img-fluid rounded-4" alt="">
    ...
    <section id="clients" class="clients section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-0 clients-wrap">
          ...
          <div class="col-xl-3 col-md-4 client-logo">
            <img src="{{asset('home/assets/img/clients/client-7.png')}}" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-3 col-md-4 client-logo">
            <img src="{{asset('home/assets/img/clients/client-8.png')}}" class="img-fluid" alt="">
          </div><!-- End Client Item -->
